    ...
    <div className="min-h-screen bg-gray-100 p-4 pb-20">
      ...
      <form onSubmit={salvar} className="bg-white p-6 rounded-2xl shadow-sm space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div><label className={labelStyle}>Nº Brinco *</label><input type="text" value={brinco} onChange={e => setBrinco(e.target.value)} className={inputStyle} placeholder="105" required /></div>
          <div><label className={labelStyle}>Raça</label><input type="text" value={raca} onChange={e => setRaca(e.target.value)} className={inputStyle} placeholder="Nelore" /></div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
            <div><label className={labelStyle}>Peso (Kg) *</label><input type="number" value={peso} onChange={e => setPeso(e.target.value)} className={inputStyle} placeholder="0.0" required /></div>
            <div><label className={labelStyle}>Data Entrada</label><input type="date" value={dataEntrada} onChange={e => setDataEntrada(e.target.value)} className={inputStyle} /></div>
        </div>
